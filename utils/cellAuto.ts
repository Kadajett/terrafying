...
function CAWorld<CAWorld> ( this: CAWorld, options: {width: number, height: number},) {
...
CAWorld.prototype.createGridFromValues = function (values: {cellType: any, value: number}[], defaultValue: {cellType: any, value: number}) {
    var newGrid: {cellType: any, value: any}[][] = [];
    this.grid = this.grid ?? [];
    debugger;
    if(values.length) {
        for (var y = 0; y < this.height; y++) {
